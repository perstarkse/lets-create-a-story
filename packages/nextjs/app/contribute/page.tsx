...
const Story: NextPage = () => {
  ...
  return (
    <div className="flex flex-col items-center m-auto max-w-4xl mt-16">
      ...
      <div className="flex flex-col items-center text-lg mb-2 px-6">
        <h2 className="font-bold">The current inspiration:</h2>
        <p className="italic">{currentStoryInspirations}</p>
      </div>
      <ContributeToStory />
    </div>
  );
